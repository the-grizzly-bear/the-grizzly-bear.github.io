# 2024-10-20 Backdoored Splunk II (Forensics)

*[image unavailable]*

*[image unavailable]*

We just have to look through the files for something off
...
Find this obfuscated section in the DNS health script that is not normal.
...
More base64 to decode

*[image unavailable]*

Get our needed authentication header value, and curl the challenge instance with it returns another base64 encoded value
