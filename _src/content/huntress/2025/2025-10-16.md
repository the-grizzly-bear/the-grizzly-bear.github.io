...
# Create service: python -m flask --app  run --host 0.0.0.0 --port <port>
...
Write-Host "OK: Service '$ServiceName' running from $AppDir â†’ http://localhost:$Port  (exe: $runPy, app: $flaskApp)"
