...
```plain text
Running the application gives you an error
```
*[image unavailable]*

```plain text
Changing perms to just trustedinstaller and removing inheritence breaks it, or the key.bin to it don’t open it
```
...
00000000   C5 C9 3B DB 84 15 34 FA E5 54 5E DC B0 F1 20 41  ÅÉ;Û.4úåT^Ü°ñ A
...
*[image unavailable]*
	...
	```plain text
Find the base64 ciphertext in the binary:
...
Decompiled in Binary Ninja in dogbolt
```plain text
